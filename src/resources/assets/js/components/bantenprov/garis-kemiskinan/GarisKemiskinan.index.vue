<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Garis Kemiskinan
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/garis-kemiskinan/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/garis-kemiskinan/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/garis-kemiskinan/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/garis-kemiskinan/' + rowData.id)
